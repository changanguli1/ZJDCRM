      ...
      {editingProject && projectForm && (
        <form className="card" onSubmit={saveProject} style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 12 }}>
            ...
            <div className="form-field"><label htmlFor="edit-desired-area">需求面积（㎡）</label><input id="edit-desired-area" aria-label="需求面积" type="number" value={projectForm.desiredArea} onChange={(event) => setProjectForm({ ...projectForm, desiredArea: event.target.value })} /></div>
